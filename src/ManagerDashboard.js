  ...
  return (
    <div style={{ textAlign: 'center', color: 'white' }}>
      <h1 style={{ fontSize: '2rem', color: '#D6C271', marginBottom: '10px', lineHeight: '1.2' }}>
        Welcome to Your Property<br />Manager Interface
      </h1>
      <p style={{ fontSize: '1rem', marginBottom: '20px', lineHeight: '1.2' }}>
        Stay organized and manage your properties efficiently
      </p>
      <button style={{ padding: '10px 20px', fontSize: '1rem', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
        View Dashboard
      </button>

      <div style={{ marginTop: '100px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '3rem', color: '#D6C271', marginBottom: '20px' }}>
          Dashboard Overview
        </h2>
        ...
        {requestData.map((request, index) => (
          <tr key={index} style={{ borderBottom: '1px solid #D6C271' }}>
            ...
            <td style={cellStyle}>
              ...
              <span style={{ color: getPriorityTextColor(request.priority), fontWeight: 'bold' }}>
                {request.priority}
              </span>
            </td>
          ...
          {tenants.map((tenant, index) => (
            <tr key={index}>
              ...
              <td style={upComingCellStyle}>
                <button
                  style={buttonStyle}
                  onClick={() => handleGenerateReport(tenant.name)}
                >
